 ...
 *	   {normal_cdf (..) is synonymous and preferred inside R}
 *
 *   void   normal_cdf_both(double x, double *cum, double *ccum,
...
double normal_cdf(double x, double mu, double sigma, int lower_tail, int log_p)
{
	...
	normal_cdf_both(x, &p, &cp, (lower_tail ? 0 : 1), log_p);
...
*/
	...
	if (y <= 0.67448975) { /* qnorm(3/4) = .6744.... -- earlier had 0.66291 */
		...
		/* Evaluate normal_cdf for 0.674.. = qnorm(3/4) < |x| <= sqrt(32) ~= 5.657 */
 ...
 */
		...
		*/
		...
		/* Evaluate normal_cdf for x in (-37.5, -5.657) union (5.657, 37.5) */
